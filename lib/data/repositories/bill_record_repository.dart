...
class BillRecordRepository {
  ...
  Future<int> sumIncomeForMonth(DateTime month) => _db.billRecordDao.sumForMonth(month, 'income');
  Future<int> sumExpenseForMonth(DateTime month) => _db.billRecordDao.sumForMonth(month, 'expense');
}
